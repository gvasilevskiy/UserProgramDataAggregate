...
@RestController
@RequestMapping("/api/quick-user-program-data-aggregate-kafka")
public class QuickUserProgramDataAggregateKafkaResource {
    private final Logger log = LoggerFactory.getLogger(QuickUserProgramDataAggregateKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public QuickUserProgramDataAggregateKafkaResource(KafkaProperties kafkaProperties) {
